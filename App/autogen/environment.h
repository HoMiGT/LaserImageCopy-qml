...
Q_IMPORT_QML_PLUGIN(LaserImageCopyPlugin)
Q_IMPORT_QML_PLUGIN(LaserImageCopyContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/LaserImageCopyContent/App.qml";
